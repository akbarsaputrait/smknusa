...
<head>
	...
	<title>Tambah Blog - Admin SMK Negeri 1 Purwosari</title>
	...
	<div class="main-container">
				...
				<ul class="nav">
					...
					<li class="nav-item nav-dropdown">
						...
						<ul class="nav-dropdown-items">
							<li class="nav-item">
								<a href="<?php echo base_url('blog/lists') ?>" class="nav-link active">
		...
		<div class="content">
			<div class="container-fluid">
				<h4>Blog / Tambah Blog</h4>
				<?php echo form_open_multipart(base_url('blog/add_post/')); ?>
				<div class="row">
					<div class="col-md-8">
							...
							<div class="card-body">
								<div class="form-group mb-4 cover-blog">
									<div class="CoverImage FlexEmbed FlexEmbed--3by1"
										 style="background-image:url(<?php echo base_url() ?>assets/imgs/logo.png)"></div>
								</div>
		...
		function readURL(input) {
			if (input.files && input.files[0]) {
				...
				reader.onload = function (e) {
					$(".cover-blog").append('<div class="CoverImage FlexEmbed FlexEmbed--3by1" style="background-image:url(' + e.target.result + ')"></div>');
				}
