...
<head>
	...
	<title>Detail Pengumuman - Admin SMK Negeri 1 Purwosari</title>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/vendor/croppie/croppie.css">
	...
	<!-- START SIDEBAR -->
		...
		<div class="content">
			<div class="container-fluid">
				<h4>Pengumuman / Detail Pengumuman / <?php echo $detail_blog['title']?> </h4>
				<?php echo form_open(base_url('pengumuman/update_post/'.$detail_blog["id"].'')); ?>
				<div class="row">
					<div class="col-md-8">
					...
					<div class="col-md-4">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col-md-12">
										<input type="text" class="form-control" name="tags_blog" id="tags_blog" value="<?php echo $detail_blog['tags']; ?>">
									</div>
								</div>
							</div>
						</div>
...
<script src="<?php echo base_url() ?>assets/vendor/croppie/croppie.js"></script>
