...
<head>
	...
	<title>Tambah Pengumuman - Admin SMK Negeri 1 Purwosari</title>
	...
	<div class="main-container">
				...
				<ul class="nav">
					...
					<li class="nav-item nav-dropdown">
						...
						<ul class="nav-dropdown-items">
							...
							<li class="nav-item">
								<a href="<?php echo base_url('pengumuman/add') ?>" class="nav-link active">
		...
		<div class="content">
			<div class="container-fluid">
				<h4>Pengumuman / Tambah Pengumuman</h4>
				<?php echo form_open(base_url('pengumuman/add_post/')); ?>
				<div class="row">
					<div class="col-md-8">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									<textarea name="konten_pengumuman" id="konten_pengumuman" required></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col-md-12">
										<input type="text" class="form-control" name="kategori_pengumuman"
											   id="kategori_pengumuman">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col-md-12">
										<input type="text" class="form-control" name="tags_pengumuman"
											   id="tags_pengumuman">
									</div>
								</div>
							</div>
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<select name="post_comment_status" class="form-control input-sm"
											id="post_comment_status" required>
...
<script>
	...
	$(document).ready(function () {
		$('#konten_pengumuman').froalaEditor({
			...
			// FILE UPLOAD
			fileUploadURL: '<?php echo base_url() ?>blog/froala_file/',
			fileUploadParams: {
				id: 'my_editor'
			},
			...
			imageDeleteURL: '<?php echo base_url() ?>blog/froala_delete/',
			...
			videoUploadURL: '<?php echo base_url() ?>blog/froala_video/',
		...
		$('#konten_pengumuman').froalaEditor('html.get');

		$('#kategori_pengumuman').tagsInput({
			defaultText: '',
			height: '',
			width: '',
		});

		$('#tags_pengumuman').tagsInput({
			defaultText: '',
			height: '',
			width: '',
		});
