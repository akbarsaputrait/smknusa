...
<head>
	...
	<title>Komentar - Admin SMK Negeri 1 Purwosari</title>
	...
	<div class="main-container">
				...
				<ul class="nav">
					...
					<li class="nav-item nav-dropdown">
						...
						<ul class="nav-dropdown-items">
							...
							<li class="nav-item">
								<a href="<?php echo base_url('pengumuman/comment') ?>" class="nav-link active">
		...
		<div class="content">
			<div class="container-fluid">
				<h4>Pengumuman / Komentar Pengumuman</h4>
				<div class="row">
					<div class="col-md-12">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<blockquote class="quote-card text-center" id="content">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		var komentar = $('#table_id').DataTable({
			...
			lengthChange: true,
			ajax: {
				url: base_url + "pengumuman/get_list_comment/",
			},
			columns: [{
				'data': 'no'
			},
		...
		$(document).on('show.bs.modal', '#detail_komentar', function (event) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					$("form").attr('action', '<?php echo base_url("pengumuman/reply_comment/")?>' + id_komentar + '');
				}
			})
		});
